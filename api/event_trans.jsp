...
if(date == null && grid == null && grids == null && data == null){
  ...
  sql = "select from_unixtime(tstamp),id,user_id,grid_id,aqi,co_avg,no2_avg,o3_avg,so2_avg,pm25_avg,rad,tstamp,lat,lon from event_trans WHERE from_unixtime(tstamp) > DATE_SUB(NOW(), INTERVAL 3 HOUR)  limit 70" ;
}
else if(grids != null)
{
String result = "";
