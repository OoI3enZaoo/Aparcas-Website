...
function showPredictDetail(){
	...
	$.getJSON("http://api.openweathermap.org/data/2.5/forecast?q=" + $('#subdistrict :selected').val() + "&&units=metric&appid=" + apiKey, function(data) {
		...
		$('#predictContent').load('predictDetail2.jsp', {"dt1": dt1, "temp1": temp1, "humid1": humid1, "dt2": dt2, "temp2": temp2, "humid2": humid2, "dt3": dt3, "temp3": temp3, "humid3": humid3, "dt4": dt4, "temp4": temp4, "humid4": humid4, "dt5": dt5, "temp5": temp5, "humid5": humid5});
     });
}
</script>
...
<div class="container">
    <div class="row">
        <div class="col">
                    ...
                    <br>
                    <h2 class="title text-center">พยากรณ์คุณภาพอากาศ</h2>
                    <h3 class="category text-center">ระบบพยากรณ์คุณภาพอากาศ</h3>
                    <br>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-5" id="predictContent">
			No Data... Yet
        </div>
    </div>
</div>
